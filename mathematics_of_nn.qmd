...
output-file: mathematics_of_nn.pdf
format:
  beamer:
    theme: "Malmoe"
    colortheme: "default"
...
<!--
This presentation used python 3.12.12.
...
if not two_layer.is_file():
    ...
    _ = plt.axis("off")
    _ = plt.text(0.01, 3.1, "$h^{(1)}_{4 \\times N} = W^{(1)}_{4 \\times 3} \\cdot X_{3 \\times N} + B^{(1)}_{4 \\times 1}$", fontsize = 40, bbox = dict(boxstyle='round', facecolor='wheat', alpha=1))
