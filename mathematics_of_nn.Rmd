...
- To that end, we do need to briefly introduce some concepts from _Linear Algebra_ and _Differential Calculus_, but will focus on an intuitive understanding.
...
if not translation.is_file():
    ...
    _ = plt.savefig("./images/translation.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 550)
    plt.close("all")
```
...
if not scale.is_file():
    ...
    _ = plt.quiver(*X[:, 3], Z[0, 3], Z[1, 3], angles='xy', scale_units='xy', scale=1., color="black", width = 0.006, alpha = 1)
    _ = plt.gcf().set_size_inches(7, 5)
    _ = plt.savefig("./images/scale.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
if not rotation.is_file():
    ...
    _ = plt.quiver(*X[:, 3], Z[0, 3], Z[1, 3], angles='xy', scale_units='xy', scale=1., color="black", width = 0.006, alpha = 1)
    _ = plt.gcf().set_size_inches(7, 5)
    _ = plt.savefig("./images/rotation.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
if not affine.is_file():
    ...
    _ = plt.quiver(*X[:, 3], Z[0, 3], Z[1, 3], angles='xy', scale_units='xy', scale=1., color="black", width = 0.006, alpha = 1)
    _ = plt.gcf().set_size_inches(7, 5)
    _ = plt.savefig("./images/affine.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
if not derivative.is_file():
    ...
    _ = plt.gcf().set_size_inches(7, 5)
    _ = plt.savefig("./images/derivative.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
if not gradient.is_file():
    ...
    _ = ax.set_zlabel('z')
    _ = plt.gcf().set_size_inches(7, 5)
    _ = plt.savefig("./images/gradient.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
if not one_layer.is_file():
    ...
    _ = plt.savefig("./images/one_layer.png", bbox_inches = "tight", transparent = "False", pad_inches= 0)
    plt.close("all")
```
...
if not two_layer.is_file():
    ...
    _ = plt.savefig("./images/two_layer.png", bbox_inches = "tight", transparent = "False", pad_inches= 0)
plt.close("all")
```
...
if not affine.is_file():
    ...
    _ = plt.quiver(*X[:, 3], Z[0, 3], Z[1, 3], angles='xy', scale_units='xy', scale=1., color="black", width = 0.006, alpha = 1)
    _ = plt.gcf().set_size_inches(7, 5)
    _ = plt.savefig("./images/relu.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
if not one_layer.is_file():
    ...
    _ = plt.savefig("./images/simple_nn.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
```{python epoch0, eval = TRUE, echo = FALSE, results = FALSE}
import matplotlib.pyplot as plt
import numpy as np
from pathlib import Path
...
if not forwardp.is_file():
    ...
    _ = plt.savefig("./images/forwardp.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```

```{r epoch0Image, echo = FALSE, fig.align = "center", dpi = 600}
...
- The optimization step has the goal of _learning_ the values of $W$ and $B$ that minimized the MSE @chollet2021deep.
...
if not gradient_descent_title.is_file():
    ...
    _ = plt.xlabel("$w$")
    _ = plt.ylabel("$e$")
    _ = plt.savefig("./images/gradient_descent_title.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
if not updatew.is_file():
    ...
    _ = plt.ylabel("$e$")
    _ = plt.gcf().set_size_inches(7, 5)
    _ = plt.savefig("./images/updatew.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
...
```{python tmp, eval = TRUE, echo = FALSE, results = FALSE}
import sympy as sym
import numpy as np
import matplotlib.pyplot as plt
import pandas as pd
...
if not epoch10.is_file():
    ...
    _ = plt.savefig("./images/epoch10.png", bbox_inches = "tight", transparent = "True", pad_inches= 0, dpi = 600)
    plt.close("all")
```
